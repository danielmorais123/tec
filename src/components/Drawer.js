...
const Drawer = ({ open, setOpen }) => {
    return (
        <motion.div initial={{ x: -200, opacity: 0 }}
            ...
            transition={{ duration: 0.5 }} id="drawer-navigation" className={`xl:hidden  rounded-t-[30px] ${!open && "hidden"} fixed z-40 h-screen p-4 overflow-y-auto bg-purple-300 w-full xs:w-80 dark:bg-gray-800`} tabindex="-1" aria-labelledby="drawer-navigation-label">
